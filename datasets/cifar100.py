...
class CIFAR100(TorchDataset):
    ...
    def __init__(self, tfm, task_id,mode,shot=5, class_per_task=5,B=8, GD_path = '') -> None:
        ...
        if mode=='train':
            ...
            cifar100 = torchvision.datasets.CIFAR100(root=os.path.expanduser("D:\\Master-An1\\Sem2\\Research\\LP-DiF\\data"),download=True, train=True,transform=tfm)
            ...
            cifar100 = torchvision.datasets.CIFAR100(root=os.path.expanduser("D:\\Master-An1\\Sem2\\Research\\LP-DiF\\data"),download=False, train=False,transform=tfm)
